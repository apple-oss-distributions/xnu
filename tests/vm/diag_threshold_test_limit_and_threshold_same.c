...
static void diag_threshold_test_limit_and_threshold_same(struct test_case *test_case, void *param);
static test_case_t diag_threshold_test_limit_and_threshold_same_test = {
	.short_name = "diag_threshold_test_limit_and_threshold_same",
	.test_name = "Test on which a diag threshold and a limit is set with same value",
	.test_code = diag_threshold_test_limit_and_threshold_same,
...
static void
diag_threshold_test_limit_and_threshold_same(struct test_case *test_case, __unused void *param)
{
	...
	diag_mem_set_jetsam_limit(WORKING_LIMIT);
	...
	diag_mem_set_jetsam_watermark(LOW_JETSAM_LIMIT << 1);
	diag_mem_set_jetsam_limit(WORKING_LIMIT << 1);
